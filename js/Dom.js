...
translateButton.addEventListener("click", function() {
  ...
  request(detectUrl, data => {
    ...
    translateUrl = `https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20190702T084028Z.6d9a7275087030e7.c7f5e34f73df150db59b46361478dc0c93bfd86c&text=${text}&lang=${
      data.lang
    }-${value1}`;
